...
class News(models.Model):
    ...
    pdf=models.FileField(upload_to="{}".format('ldl/circular/'),blank=True)
class Carousal(models.Model):
    image=models.ImageField(upload_to="{}".format('ldl/carousal/'))
...
class Fame(models.Model):
    ...
    image=models.ImageField(upload_to="{}".format('ldl/fame/'))
