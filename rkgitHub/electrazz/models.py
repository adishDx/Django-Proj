...
class News(models.Model):
    ...
    pdf=models.FileField(upload_to="{}".format('electrazz/circular/'),blank=True)
class Carousal(models.Model):
    image=models.ImageField(upload_to="{}".format('electrazz/carousal/'))
...
class Fame(models.Model):
    ...
    image=models.ImageField(upload_to="{}".format('electrazz/fame/'))
...
class Core(models.Model):
    ...
    branch = models.CharField(max_length=10, default="CSE", choices=branch_choice)
    year=models.CharField(max_length=15,default='',choices=year_choice)
    image=models.ImageField(upload_to='electrazz/core/')
