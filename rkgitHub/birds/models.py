...
class News(models.Model):
    ...
    pdf=models.FileField(upload_to="{}".format('birds/circular/'))
class Carousal(models.Model):
    image=models.ImageField(upload_to="{}".format('birds/carousal/'))
...
class Fame(models.Model):
    ...
    image=models.ImageField(upload_to="{}".format('birds/fame/'))
